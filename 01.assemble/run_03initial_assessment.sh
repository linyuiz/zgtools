...
busco -o result -l /database/update/BUSCO/Latest/your_busco_odb10_or_12 -m geno -c 60 -i used.genome.fa --offline --long -f --miniprot
🚀zgtools/overdose
overdose BUSCO HIFI_ONT_HIC.diploid.fa geno miniprot your_busco_odb10_or_12 /database/update/BUSCO/Latest 60 simple
##✍️results like this:
Item                                 Number  Percent(%)
