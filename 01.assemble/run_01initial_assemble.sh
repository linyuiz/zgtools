#!/bin/bash
##⭐️hifiasm assemble
1️⃣hifiasm hifi+ont+hic(https://github.com/chhylp123/hifiasm)
...
##⭐️verkko assemble(https://github.com/marbl/verkko)
...
##⭐️other assemble
1️⃣shasta assemble(https://github.com/paoloshasta/shasta/)
